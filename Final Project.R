...
# Load a manageable chunk of the dataset (first 100,000 rows)
sampled_data <- fread("/Users/lyndseyhuss/Documents/MGSC_410/MGSC_410/song_lyrics.csv", nrows = 100000)
